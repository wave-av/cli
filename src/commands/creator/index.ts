 ...
 *
 * WHY (verified against the WAVE gateway's origin/main, 2026-09-05, not assumed from this file
 ...
 * of what the body says next (the gateway's own doctrine, in its unserved-spoke-routes module).
 *
 * HEALING: once the WAVE gateway ships a real `/v1/creators/*` route (tracked separately there), remove
...
const CREATOR_BACKEND_UNAVAILABLE =
  ...
  "served. Watch https://changelog.wave.online for when creator monetization ships, then retry.";
